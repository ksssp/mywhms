...
export default {
    ...
    data: function () {
        return {
            ...
            totalRows: 0,
            entityCreateUrl: "/administration/expenseTypes/create/",
            footerBgVariant: "light",
            downloadFileName: "expenseTypesList",
            fields: [
                { data: "expenseType", title: "Expense Type" },
                { data: "expenseCategory", title: "Expense Category" },
