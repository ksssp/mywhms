...
import { getIncomeTypes } from "@/services/incomeType.service";
...
export default {
    ...
    data: function () {
        return {
            ...
            totalRows: 0,
            entityCreateUrl: "/administration/incomeTypes/create/",
            footerBgVariant: "light",
            downloadFileName: "incomeTypesList",
            fields: [
                { data: "incomeType", title: "Income Type" },
                { data: "incomeCategory", title: "Income Category" },
                { data: "incomeSource", title: "Income Source" },
