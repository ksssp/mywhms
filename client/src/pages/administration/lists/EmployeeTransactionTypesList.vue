...
export default {
    ...
    data: function () {
        return {
            ...
            pageTitle: 'Employee Transaction Types',
            totalRows: 0,
            entityCreateUrl: "/administration/employeeTransactionTypes/create/",
            footerBgVariant: "light",
            downloadFileName: "employeeTransactionTypesList",
            fields: [
                { data: "employeeTransactionType", title: "EmployeeTransaction Type" },
                { data: "debitAllowed", title: "Debit Allowed", render: function(debitAllowed) { return debitAllowed ? 'Yes' : 'No'; } },
                { data: "creditAllowed", title: "Credit Allowed", render: function(creditAllowed) { return creditAllowed ? 'Yes' : 'No'; } },
