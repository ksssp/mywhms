                ...
                <div class="card-body" v-else>
                    ...
                    <b-tabs class="tickets-tab-switch">
                        <b-tab title="Overview" active>
                            ...
                            <div class="mx-4">
                                <ReceiptForm v-if="editMode" :form-data="loadedEntity" :submit-mode="submitMode" 
                                    @saved="saved" @cancelForm="editCancelled"></ReceiptForm>
...
import ReceiptForm from '@/pages/accounting/forms/ReceiptForm.vue';
...
export default {
    ...
    data: function () {
        return {
            ...
            entityDetailsTable: {
                ...
                items: [       // update entity specific json data in an array format - Receipt
    ...
    methods: {
        loadEntityData(entityId) {
            ...
            getReceiptById(entityId).then(response => {
