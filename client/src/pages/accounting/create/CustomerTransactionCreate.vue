    ...
    <div class="tables">
        ...
        <div class="row col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="mx-4">
                        <CustomerTransactionForm :form-data="loadedEntity" :submit-mode="submitMode" 
                            @saved="saved" @cancelForm="createCancelled"></CustomerTransactionForm>
                    </div>
                </div>
            </div>
        </div>
...
<script>
import CustomerTransactionForm from "../forms/CustomerTransactionForm.vue";
...
export default {
    ...
    data: function () {
        return {
            moduleTitle: 'Customer Transactions',
            pageTitle: "Add a receipt",
            entityNamePlural: "Customer Transactions",
